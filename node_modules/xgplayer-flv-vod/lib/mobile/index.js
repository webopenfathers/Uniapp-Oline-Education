...
var _flvVodMobile = require('./flv-vod-mobile');

var _flvVodMobile2 = _interopRequireDefault(_flvVodMobile);
...
var FlvVodPlayer = function (_Player) {
  ...
  function FlvVodPlayer(config) {
    ...
    _this.context = new _xgplayerHelperUtils.Context(flvAllowedEvents);
    _this.initEvents();
  ...
  _createClass(FlvVodPlayer, [{
    ...
    value: function initFlv() {
      var flv = this.context.registry('FLV_CONTROLLER', _flvVodMobile2.default)(this);
      this.context.init();
      this.flv = flv;
      this.mse = flv.mse;
      return flv;
    ...
    value: function switchURL(url) {
      this.config.url = url;
      var context = new _xgplayerHelperUtils.Context(flvAllowedEvents);
      var flv = context.registry('FLV_CONTROLLER', _flvVodMobile2.default)(this, this.mse);
      context.init();
