...
var Mp4Remuxer = function () {
  function Mp4Remuxer() {
    ...
    var browser = _xgplayerHelperUtils.Sniffer.browser;
    ...
    value: function _remuxAudio(track) {
      ...
      while (samples.length && maxLoop-- > 0) {
        ...
        if (_xgplayerHelperUtils.logger.long) {
          _xgplayerHelperUtils.logger.log(this.TAG, 'audio dts ' + dts, 'pts ' + dts, 'originDts ' + originDts, 'duration ' + sampleDuration);
        }
