...
var SpsParser = _xgplayerHelperCodec.avc.SpsParser,
    NalUnit = _xgplayerHelperCodec.avc.NalUnit;
var SpsParserHEVC = _xgplayerHelperCodec.hevc.SpsParserHEVC,
    NalUnitHEVC = _xgplayerHelperCodec.hevc.NalUnitHEVC;
...
var FlvDemuxer = function (_EventEmitter) {
  ...
  _createClass(FlvDemuxer, [{
    ...
    value: function _parseFlvTagHeader(buffer) {
      var offset = 0;
      var flvTag = new _xgplayerHelperModels.FlvTag();
    ...
    value: function _parseScriptData(flvTag, buffer) {
      ...
      var info = new _amfParser2.default().resolve(flvTag.data, flvTag.data.length);
    ...
    value: function _parseVideoData(flvTag, buffer) {
      ...
      var vSample = new _xgplayerHelperModels.VideoSample(flvTag);
      ...
      if (codecID === 7 || codecID === 12) {
        ...
        if (flvTag.avcPacketType === 0) {
          ...
          var dv = new _xgplayerHelperModels.XGDataView(data.buffer);
