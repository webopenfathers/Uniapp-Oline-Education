...
var INTERNAL_EVENTS = _demuxer2.default.EVENTS;
...
var FlvDemuxer = function () {
  function FlvDemuxer() {
    ...
    this.demuxer = new _demuxer2.default();
  }
  ...
  _createClass(FlvDemuxer, [{
    ...
    value: function initVideoTrack() {
      this._trackNum++;
      var videoTrack = new _xgplayerHelperModels.VideoTrack();
      videoTrack.meta = new _xgplayerHelperModels.VideoTrackMeta();
    ...
    value: function initAudioTrack() {
      this._trackNum++;
      var audioTrack = new _xgplayerHelperModels.AudioTrack();
      audioTrack.meta = new _xgplayerHelperModels.AudioTrackMeta();
