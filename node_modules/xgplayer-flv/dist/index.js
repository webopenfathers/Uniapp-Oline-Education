(function (global, factory) {
  ...
  function _softSolutionProbe () {
    ...
    if (WebComponentSupported) {
      var mVideo = window.customElements.get('mobile-video');
  ...
  var softSolutionProbe = _softSolutionProbe;

  var _common = /*#__PURE__*/Object.freeze({
    __proto__: null,
    debounce: debounce,
    caculate: caculate,
    softSolutionProbe: softSolutionProbe
  });
  ...
  var Context = function () {
    function Context() {
      ...
      _classCallCheck$6(this, Context);
      ...
      value: function registry(tag, cls) {
        ...
        var enhanced = function (_cls) {
          ...
          function enhanced(a, b, c) {
            _classCallCheck$6(this, enhanced);
  ...
  var DevLogger = function () {
    function DevLogger() {
      ...
      _classCallCheck$a(this, DevLogger);
  ...
  var AAC = function () {
    function AAC() {
      _classCallCheck$b(this, AAC);
    }

    _createClass$b(AAC, null, [{
      key: 'getSilentFrame',
  ...
  var SPSParser$1 = function () {
    ...
    _createClass$i(SPSParser, null, [{
      ...
      key: 'parseVPS',
      value: function parseVPS(uint8array, hvcC) {
        hvcC = hvcC || {};
        var rbsp = SPSParser._ebsp2rbsp(uint8array);
        ...
        gb.readBits(12);
        var vpsMaxSubLayersMinus1 = gb.readBits(3);
        hvcC.numTemporalLayers = Math.max(hvcC.numTemporalLayers || 0, vpsMaxSubLayersMinus1 + 1);
        gb.readBits(17);
        SPSParser._readProfileTierLevel(gb, vpsMaxSubLayersMinus1, hvcC);

        return hvcC;
      }
    }, {
      key: 'parseSPS',
      value: function parseSPS(uint8array, hvcC) {
        hvcC = hvcC || {};
        var rbsp = SPSParser._ebsp2rbsp(uint8array);
        var gb = new Golomb$2(rbsp);
        ...
        hvcC.numTemporalLayers = Math.max(maxSubLayersMinus1 + 1, hvcC.numTemporalLayers || 0);
        hvcC.temporalIdNested = tINf = gb.readBits(1); // temporal_id_nesting_flag

        profileTierLevel = SPSParser._readProfileTierLevel(gb, maxSubLayersMinus1, hvcC);

        spsId = gb.readUEG(); // sps id
        hvcC.chromaFormatIdc = chromaFormatIdc = gb.readUEG();
        ...
        hvcC.bitDepthLumaMinus8 = bitDepthLumaMinus8 = gb.readUEG(); // bit_depth_luma_minus8
        hvcC.bitDepthChromaMinus8 = bitDepthChromaMinus8 = gb.readUEG(); // bit_depth_chroma_minus8
      ...
      value: function _readProfileTierLevel(gb, maxSubLayersMinus1, hvcC) {
        var generalTierFlag = hvcC.generalTierFlag || 0;
        hvcC.generalProfileSpace = gb.readBits(2);
        hvcC.generalTierFlag = Math.max(gb.readBits(1), generalTierFlag);
        hvcC.generalProfileIdc = Math.max(gb.readBits(5), hvcC.generalProfileIdc || 0);
        hvcC.generalProfileCompatibilityFlags = gb.readBits(32);
        hvcC.generalConstraintIndicatorFlags = [gb.readBits(8), gb.readBits(8), gb.readBits(8), gb.readBits(8), gb.readBits(8), gb.readBits(8)];
        var generalLevelIdc = gb.readBits(8);
        ...
        return {
          general_profile_space: hvcC.generalProfileSpace,
          general_tier_flag: hvcC.generalTierFlag,
          general_profile_idc: hvcC.generalProfileIdc,
          general_level_idc: hvcC.generalLevelIdc
        };
      }
    }, {
      key: '_skipScalingList',
  ...
  var Nalunit$1 = function () {
    ...
    _createClass$l(Nalunit, null, [{
      key: 'getNalunits',
      value: function getNalunits(buffer, meta) {
        if (buffer.length - buffer.position < 4) {
          return [];
        }
        ...
        if (buf.getInt32(position) === 1 || buf.getInt16(position) === 0 && buf.getInt8(position + 2) === 1) {
          return Nalunit.getAnnexbNals(buffer, meta.hvcC);
        } else {
          return Nalunit.getHvccNals(buffer, meta.hvcC);
        }
      }
    }, {
      key: 'getAnnexbNals',
      value: function getAnnexbNals(buffer, hvcC) {
      ...
      key: 'getHvccNals',
      value: function getHvccNals(buffer, hvcC) {
      ...
      key: 'analyseNal',
      value: function analyseNal(unit, hvcC) {
        ...
        switch (type) {
          ...
          case 32:
            // VPS
            unit.vps = true;
            SPSParser$1.parseVPS(unit.body, hvcC);
            break;
          case 33:
            // SPS
            unit.sps = SPSParser$1.parseSPS(unit.body, hvcC);
            break;
          case 34:
            // PPS
            unit.pps = true;
    ...
    _createClass$m(Compatibility, [{
      ...
      value: function doFixAudio(first, streamChangeStart) {
        ...
        audioSamples.forEach(function (sample, idx) {
          ...
          _this2.audioUnsyncTime = caculate$1.fixedFloat(_this2.audioUnsyncTime + unSyncDuration, 2);
  ...
  var UTF8 = function () {
    function UTF8() {
      _classCallCheck$n(this, UTF8);
    }

    _createClass$n(UTF8, null, [{
      key: 'decode',
  ...
  var AMFParser = function () {
    function AMFParser() {
      _classCallCheck$o(this, AMFParser);

      this.offset = 0;
      this.readOffset = this.offset;
    }

    _createClass$o(AMFParser, [{
      key: 'resolve',
  ...
  var SpsParser$1 = avc.SpsParser,
      NalUnit$1 = avc.NalUnit;
  var SpsParserHEVC$1 = hevc.SpsParserHEVC,
      NalUnitHEVC$1 = hevc.NalUnitHEVC;

  var DEMUX_EVENTS$1 = EVENTS.DEMUX_EVENTS;

  var FlvDemuxer = function () {
    function FlvDemuxer() {
      _classCallCheck$p(this, FlvDemuxer);
    ...
    _createClass$p(FlvDemuxer, [{
      ...
      value: function parseFlvHeader(header) {
        if (!FlvDemuxer.isFlvFile(header)) {
          this.emit(DEMUX_EVENTS$1.DEMUX_ERROR, this.TAG, new Error('invalid flv file,' + header.join(',')));
          this.doParseFlv();
        } else {
      ...
      value: function _parseFlvTag() {
        var tagSize = this.loaderBuffer.toInt(1, 3);
      ...
      value: function _parseAACData(chunk) {
        ...
        if (format !== 10) {
          this.emit(DEMUX_EVENTS$1.DEMUX_ERROR, this.TAG, new Error('invalid audio format: ' + format));
          return;
        }
      ...
      value: function _parseHevcData(chunk) {
        ...
        if (codecID === 7 || codecID === 12) {
          ...
          if (chunk.avcPacketType === 0) {
            ...
            var nals = _hevc ? NalUnitHEVC$1.getHvccNals(new Stream$1(chunk.data.buffer)) : NalUnit$1.getAvccNals(new Stream$1(chunk.data.buffer));
            ...
            for (var _i = 0; _i < nals.length; _i++) {
              ...
              if (unit.sei) {
                this.emit(DEMUX_EVENTS$1.SEI_PARSED, Object.assign(unit.sei, {
                  dts: chunk.dts
                }));
              }
            ...
            chunk.nals = nals;
            if (chunk.isKeyframe) {
              this.emit(DEMUX_EVENTS$1.ISKEYFRAME, chunk.dts + chunk.cts);
            }
  ...
  var Buffer$1 = function () {
    function Buffer(buffer) {
      _classCallCheck$q(this, Buffer);

      this.buffer = buffer || new Uint8Array(0);
    }

    _createClass$q(Buffer, [{
      key: 'write',
  ...
  var Fmp4 = function () {
    function Fmp4() {
      _classCallCheck$r(this, Fmp4);
    }

    _createClass$r(Fmp4, null, [{
      key: 'size',
      ...
      value: function hvc1(track) {
        ...
        var data = [0x00, 0x00, 0x00, // reserved
        0x00, 0x00, 0x00, // reserved
        0x00, 0x01, // data_reference_index
        0x00, 0x00, // pre_defined
        0x00, 0x00, // reserved
        ...
        var hvcCBox = void 0;
        if (hvcC) {
          var pcf = hvcC.generalProfileCompatibilityFlags;
          var cif = hvcC.generalConstraintIndicatorFlags;
          var numOfArrays = (vps ? 1 : 0) + (sps ? 1 : 0) + (pps ? 1 : 0);
          hvcCBox = [0x01, // configurationVersion
          hvcC.generalProfileSpace << 6 | hvcC.generalTierFlag << 5 | hvcC.generalProfileIdc, pcf >>> 24, pcf >>> 16, pcf >>> 8, pcf, cif[0], cif[1], cif[2], cif[3], cif[4], cif[5], hvcC.generalLevelIdc, 0xF0, 0x00, // min_spatial_segmentation_idc
          0xFC, // parallelismType
          hvcC.chromaFormatIdc | 0xFC, hvcC.bitDepthLumaMinus8 | 0xF8, hvcC.bitDepthChromaMinus8 | 0xF8, 0x00, 0x00, // avgFrameRate
          hvcC.numTemporalLayers << 3 | hvcC.temporalIdNested << 2 | 3, numOfArrays];
          var write = function write(x) {
            var _hvcCBox;

            hvcCBox.push(x.length >> 8, x.length);
            (_hvcCBox = hvcCBox).push.apply(_hvcCBox, _toConsumableArray$2(x));
          };
          if (vps) {
            hvcCBox.push(0xA0, 0x00, 1);
            write(vps);
          }
          if (sps) {
            hvcCBox.push(0xA1, 0x00, 1);
            write(sps);
          }
          if (pps) {
            hvcCBox.push(0xA2, 0x00, 1);
            write(pps);
          }
          var size = hvcCBox.length + 8;
          data.push(size >> 24, size >> 16, size >> 8, size, 0x68, 0x76, 0x63, 0x43);
        } else {
          hvcCBox = [0x00, 0x00, 0x00, 0x7A, 0x68, 0x76, 0x63, 0x43, 0x01, //configurationVersion
        ...
        data.push.apply(data, _toConsumableArray$2(hvcCBox));
  ...
  var Mp4Remuxer = function () {
    function Mp4Remuxer() {
      ...
      _classCallCheck$s(this, Mp4Remuxer);
      ...
      value: function _remuxVideo(videoTrack) {
        ...
        if (this.mp4Durations.keys.length > 1e4) {
          ...
          this.mp4Durations.keys.forEach(function (key) {
            _this.mp4Durations[key] = tmp[key];
          });
        }
  ...
  var FlvController = function () {
    ...
    _createClass$t(FlvController, [{
      ...
      value: function initComponents() {
        ...
        this._context.registry('LOADER_BUFFER', Buffer);
        ...
        if (this._player.config.compatibility !== false) {
          this._context.registry('COMPATIBILITY', Compat);
        }
  ...
  var FlvPlayer = function (_Player) {
    ...
    function FlvPlayer(config) {
      _classCallCheck$u(this, FlvPlayer);
    ...
    _createClass$u(FlvPlayer, [{
      ...
      value: function initFlvBackupEvents(flv, ctx) {
        ...
        flv.on(EVENTS.REMUX_EVENTS.MEDIA_SEGMENT, function () {
          ...
          if (mediaLength === 0) {
            ...
            _this3.context = ctx;
            if (_this3.paused) {
              _get$1(FlvPlayer.prototype.__proto__ || Object.getPrototypeOf(FlvPlayer.prototype), 'play', _this3).call(_this3);
            }
          }
        });
      ...
      value: function destroy() {
        ...
        _get$1(FlvPlayer.prototype.__proto__ || Object.getPrototypeOf(FlvPlayer.prototype), 'destroy', this).call(this);
  ...
  var NalUnit$2 = avc.NalUnit;
  var NalUnitHEVC$2 = hevc.NalUnitHEVC;
  ...
  var FlvController$1 = function () {
    function FlvController(player) {
      _classCallCheck$v(this, FlvController);
        ...
        if (this._player.video) {
          ...
          videoTrack.samples.forEach(function (sample) {
            ...
            if (_this._isHEVC(videoTrack.meta)) {
              nals = NalUnitHEVC$2.getHvccNals(buffer);
            } else {
              nals = NalUnit$2.getNalunits(buffer);
            }
  ...
  var FlvPlayer$1 = function (_Player) {
    ...
    function FlvPlayer(config) {
      _classCallCheck$x(this, FlvPlayer);
    ...
    _createClass$x(FlvPlayer, [{
      ...
      value: function initPlayer() {
        ...
        this.context = new Context$1(flvAllowedEvents$1);
  ...
  var FlvLivePlayer = function () {
    function FlvLivePlayer(config) {
      _classCallCheck$y(this, FlvLivePlayer);
    ...
    _createClass$y(FlvLivePlayer, null, [{
      key: 'install',
      value: function install(name, plugin) {
        return Player.install(name, plugin);
      }
  ...
  var debounce$1 = common.debounce;
  ...
  var FlvVodPlayer = function (_Player) {
    ...
    _createClass$A(FlvVodPlayer, null, [{
      key: 'isSupported',
      value: function isSupported() {
        return window.MediaSource && window.MediaSource.isTypeSupported('video/mp4; codecs="avc1.42E01E,mp4a.40.2"');
      }
    ...
    _createClass$A(FlvVodPlayer, [{
      ...
      value: function start() {
        ...
        if (!this.context) {
          this.context = new Context$1(flvAllowedEvents$2);
        }
        var flv = this.initFlv();
        flv.loadMeta();
        _get$3(FlvVodPlayer.prototype.__proto__ || Object.getPrototypeOf(FlvVodPlayer.prototype), 'start', this).call(this, flv.mse.url);
        this.started = true;
      }
    }, {
      key: 'initFlv',
      ...
      value: function switchURL(url) {
        this.config.url = url;
        var context = new Context$1(flvAllowedEvents$2);
