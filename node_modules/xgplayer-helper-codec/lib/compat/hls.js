...
var Compatibility = function () {
  ...
  _createClass(Compatibility, [{
    ...
    value: function doFix() {
      ...
      if (videoChanged) {
        ...
        if (!this._isSegmentsContinuous() && ops && ops.start !== undefined) {
          ...
          _xgplayerHelperUtils.logger.log(this.TAG, 'fix video for _isSegmentsContinuous()， delta:', avDelta);
    ...
    value: function doFixAudio(first, streamChangeStart) {
      ...
      var silentFrame = _aac2.default.getSilentFrame(meta.originCodec, meta.channelCount);
      ...
      if (this._firstVideoSample && first) {
        ...
        if (_gap === this._videoLargeGap) {
          ...
          _xgplayerHelperUtils.logger.warn(this.TAG, 'fill ' + silentSampleCount + ' frames for av align');
      ...
      for (var _i7 = 1; _i7 < audioSamples.length;) {
        ...
        if (delta >= 10 * iRefSampleDuration) {
          ...
          _xgplayerHelperUtils.logger.warn(this.TAG, 'inject ' + missingCount + ' audio frame for ' + delta + ' ms gap, index=' + _i7);
