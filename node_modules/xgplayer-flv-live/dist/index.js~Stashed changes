(function (global, factory) {
  ...
  var AudioTrack = function (_Track) {
     ...
     */
    function AudioTrack() {
      _classCallCheck$h(this, AudioTrack);
  ...
  var VideoTrack = function (_Track2) {
     ...
     */
    function VideoTrack() {
      _classCallCheck$h(this, VideoTrack);
  ...
  var Tracks = function () {
    function Tracks() {
      _classCallCheck$h(this, Tracks);

      this.audioTrack = null;
      this.videoTrack = null;
    }

    _createClass$h(Tracks, [{
      key: 'destroy',
      value: function destroy() {
        this.audioTrack = null;
        this.videoTrack = null;
  ...
  var UTF8 = function () {
    function UTF8() {
      _classCallCheck$i(this, UTF8);
    }

    _createClass$i(UTF8, null, [{
      key: 'decode',
  ...
  var AMFParser = function () {
    function AMFParser() {
      _classCallCheck$j(this, AMFParser);

      this.offset = 0;
      this.readOffset = this.offset;
    }

    _createClass$j(AMFParser, [{
      key: 'resolve',
  ...
  var FlvDemuxer = function () {
    function FlvDemuxer() {
      _classCallCheck$l(this, FlvDemuxer);
  ...
  var FetchLoader = function () {
    function FetchLoader(configs) {
      _classCallCheck$m(this, FetchLoader);
  ...
  var FlvController = function () {
    ...
    _createClass$y(FlvController, [{
      ...
      value: function loadData() {
        ...
        this.emit(LOADER_EVENTS$2.LADER_START, url, {}, this.configs.retryTimes);
      }
    }, {
      key: 'pause',
      ...
      value: function play() {
        ...
        if (this.hasPlayed) {
          return this.mse.cleanBuffers().then(function () {
            _this5.switchURL(_this5.config.url);
  ...
  var FlvController$1 = function () {
    function FlvController(player) {
      _classCallCheck$F(this, FlvController);
  ...
  var Logger$1 = function () {
    function Logger() {
      _classCallCheck$G(this, Logger);
    }

    _createClass$G(Logger, [{
      key: 'warn',
      value: function warn() {}
    }]);
  ...
  var FlvPlayer$1 = function (_Player) {
    ...
    function FlvPlayer(config) {
      _classCallCheck$H(this, FlvPlayer);
  ...
  var FlvLivePlayer = function () {
    function FlvLivePlayer(config) {
      _classCallCheck$I(this, FlvLivePlayer);
    ...
    _createClass$I(FlvLivePlayer, null, [{
      key: 'install',
      value: function install(name, plugin) {
        return Player.install(name, plugin);
      }
